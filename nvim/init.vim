...
function! SetWarningType(entry) " {{{2
  if a:entry.type ==# ''
...
hi NeomakeErrorMessage ctermfg=160
hi NeomakeWarningMessage ctermfg=148
let g:neomake_warning_sign={'text': '⚠', 'texthl': 'NeomakeWarningMessage'}
let g:neomake_error_sign={'text': '✘', 'texthl': 'NeomakeErrorMessage'}

" Makes deoplete smart
set autochdir

" rinse and repeat for all register mappings, i.e. c, d, x, X
